...
kmer_matrix_cpp <- function(sequences, kmer_length, from_range = 0L, to_range = NULL, mask = NULL, add_mask = FALSE) {
    .Call('_prego_kmer_matrix_cpp', PACKAGE = 'prego', sequences, kmer_length, from_range, to_range, mask, add_mask)
}
