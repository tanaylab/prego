...
#'
#' @source \url{https://jaspar.elixir.no/downloads/}
"JASPAR_motifs"
...
#' @format A data frame containing the PSSMs ('A', 'C', 'G' and 'T' columns), with an additional column 'motif' containing the motif name.
#'
#' @references Jolma, A., Yin, Y., Nitta, K. et al. DNA-dependent formation of transcription factor pairs alters their binding specificity. Nature 534, S15–S16 (2016). \doi{10.1038/nature18912}
#'
#' @source \doi{10.1038/nature18912}
"JOLMA_motifs"
...
#'
#' @source \url{https://hocomoco11.autosome.org/downloads/}
"HOCOMOCO_motifs"
